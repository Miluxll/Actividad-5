...
agenda_telefonica = {}
def agenda_contacto(nombre, telefono, correo):
    agenda_telefonica[nombre] = telefono
    print(f"Nombre: {nombre}")
    
def buscar_contacto(nombre):
    if nombre in agenda_telefonica:
        print(f"Nombre: {nombre}, telefono: {agenda_telefonica[nombre]}, correo: {agenda_telefonica[nombre]}")
    else:
...
while True:
    ...
    if opcion == "1":
        ...
        correo = input("Correo: ")
        agenda_contacto(nombre, telefono, correo)
